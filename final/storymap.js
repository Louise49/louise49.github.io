  ...
  storymap: {
    slides: [
    ...
    },
     {
      ...
      text: {
        headline: "729声工场",
        text: "<p> 以声动人，用心做事。创始于2005年7月29日，原名729配音组。2016年7月29日，729配音组正式更名729声工场，发展成为一支专业配音团队。著名配音导演及演员张杰为该品牌创始人之一。<br>代表作：动画《狐妖小红娘》、《全职高手》、游戏《仙剑奇侠传》系列等。</p>"
      },
      location: {
        name: "729声工场",
    ...
    },
    {
   ...
   },
     {
      ...
      text: {
        headline: "北斗企鹅工作室",
        text: "<p> 奇迹，正在发声。成立于2014年，是一家专注于ACG（动画，漫画及配音）领域的专业声优公司。团队目前拥有专职声优艺人四十余名，北斗企鹅以保证作品质量和诚意为核心理念。<br>在选人方面，以优秀的年轻配音演员为主，成熟配音演员为辅。</p> "
      },
      location: {
        name: "北斗企鹅工作室",
        icon:"https://dl.airtable.com/Pti3l6tdQMypu15hRJ5S_red-pushpin.png",
    ...
    },
    {
     ...
     text: {
       headline: "冠声文化",
       text: "<p> 用声音碰撞心灵，让耳朵谈一场恋爱！成立于2017年，冠声的声优团队分为两大阵营，以北京为阵地的声优团队主要生产个性化的音频产品；以全国范围内建立的冠声声优联盟，会接到和各平台合作的音频产品录制及部分作品的配音角色任务。</p> "
     },
     location: {
       name: "冠声文化",
       icon:"https://dl.airtable.com/Pti3l6tdQMypu15hRJ5S_red-pushpin.png",
   ...
   },
   {
    ...
    text: {
      headline: "音熊联萌",
      text: "<p>  熊窝饲养员“干脆面”专属工作间。由知名配音演员谢添天、冯骏骅、夏磊、沈达威和鬼月于2013年2月5日共同创办，是以动漫游戏音频后期，声优经济活动及偶像化，泛二次元IP创作与孵化为主要业务方向的有爱团体。<br>音熊联萌现旗下拥有国内知名声优艺人近二十人，主要二次元向作品有：《斗破苍穹》、《择天记》、《全职法师》、《中国惊奇先生》、《王牌御史》等；游戏《天谕》、《剑网三》、《天下3》、《秦时明月》等。2017年成立首支声优偶像少女组合V17。</p> "
    },
    location: {
      name: "音熊联萌",
      icon:"https://dl.airtable.com/Pti3l6tdQMypu15hRJ5S_red-pushpin.png",
  ...
  },
    {
     ...
     text: {
       headline: "领声文化",
       text: "<p> 与声音相遇的专属时间。成立于2014年，由国家一级演员、著名配音导演狄菲菲女士创立于2014年。领声以有声语言为资源，通过各种渠道向社会提供专业影视后期声音制作、有声读物制作、各类声音演绎活动及演出策划服务，同时也致力于声音演绎人才的培养。</p> "
     },
     location: {
       name: "领声文化",
       icon:"https://dl.airtable.com/Pti3l6tdQMypu15hRJ5S_red-pushpin.png",
     ...
     },
     {
      ...
      text: {
        headline: "边江工作室",
        text: "<p> 成立于2016年，是由知名配音演员边江创建的配音团队。以影视配音为主要业务，亦涉猎二次元领域。代表作有影视剧《许你浮生若梦》、广播剧《天宝伏妖录》、动画《空气侠》、有声漫画《头条都是他》等。</p> "
      },
      location: {
        name: "边江工作室",
        icon:"https://dl.airtable.com/Pti3l6tdQMypu15hRJ5S_red-pushpin.png",
    ...
    },
    {
     ...
     text: {
       headline: "瞬心文化",
       text: "<p> 成立于2017年，主营二次元产业IP孵化及投资、IP衍生品设计开发销售、影视动漫游戏配音（音效、音乐）服务、声优艺人培训与经纪。总部位于杭州，北京、上海设有分舵。<br>旗下艺人出演影视作品有《复仇者联盟》系列、《哈利波特》系列、《步步惊心》、《花千骨》、等，游戏作品有《魔兽世界》、《星际争霸》、《英雄联盟》、《王者荣耀》等，动漫作品有《秦时明月》、《武庚纪》、《一人之下》、《那年那兔那些事儿》、《大护法》《斗罗大陆》等。</p> "
     },
     location: {
       name: "瞬心文化",
       icon:"https://dl.airtable.com/Pti3l6tdQMypu15hRJ5S_red-pushpin.png",
